...
// just gave some of this work names so it might be easier to maintain in the future :) It might make sense to move these new functions into another file to keep the concerns separate
...
attackButton.addEventListener('click', () => {
    ...
    if (!attackResult) noAttack(); 
    
    attackResultHappened();
